<script lang="ts">
    let suggestions = [
        "Find me suggestions for a multipitch 5.9 in Red Rocks",
        "Show me boulder problems V3-V4 in Bishop CA",
        `Tell me about the climb "Midnight Lightning" in Yosemite`,
